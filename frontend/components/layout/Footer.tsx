    ...
    <footer className="border-t border-white/[0.06] bg-[#030303]">
      ...
      <div className="border-b border-white/[0.06]">
        <div className="container flex flex-col items-center gap-5 py-14 text-center md:py-16">
          ...
          <p className="max-w-md text-[13px] leading-[1.7] text-neutral-500">
            Be the first to know about new collections, protection gear, and motorcycle suits from RACEVOR.
          </p>
          <form onSubmit={handleSubscribe} className="mt-1 flex w-full max-w-md">
            ...
            <input
              ...
              className="h-12 min-w-0 flex-1 border border-white/[0.08] bg-neutral-900 px-4 text-[13px] text-white placeholder:text-neutral-600 focus:border-white/20 focus:outline-none focus:ring-0"
            />
            <button
              type="submit"
      ...
      <div className="container grid gap-10 py-14 md:grid-cols-12 md:gap-8 md:py-16">
        ...
        <div className="md:col-span-4">
          ...
          <p className="mt-4 max-w-sm text-[13px] leading-[1.7] text-neutral-500">
            Premium motorcycle protection and racing suits. CE Level 2 armor, bio-armor system,
            full-grain leather construction — designed for riders who demand more.
          </p>
      ...
      <div className="border-t border-white/[0.06]">
        <div className="container flex flex-col gap-3 py-5 text-[11px] text-neutral-600 sm:flex-row sm:items-center sm:justify-between">
          <p>© {year} RACEVOR. All rights reserved.</p>
          <div className="flex flex-wrap items-center gap-x-4 gap-y-1">
            ...
            <a href="https://b2b.racevor.com" className="transition-colors hover:text-white/60">Wholesale B2B</a>
