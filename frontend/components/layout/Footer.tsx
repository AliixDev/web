    ...
    <footer className="border-t border-border bg-background">
      ...
      <div className="border-b border-border">
        <div className="container flex flex-col items-center gap-5 py-14 text-center md:py-16">
          <p className="eyebrow">Built for the ride</p>
      ...
      <div className="container grid gap-10 py-14 md:grid-cols-12 md:gap-8 md:py-16">
        ...
        <nav aria-label="Help" className="md:col-span-2">
          ...
          <ul className="mt-5 space-y-2.5 text-[13px]">
            ...
            <li className="pt-1">
              <Link
                href="/seller/login"
                className="inline-flex items-center gap-1 text-neutral-700 transition-colors hover:text-foreground"
              >
                Seller login
              </Link>
            </li>
        ...
        <nav aria-label="Company" className="md:col-span-2">
          ...
          <ul className="mt-5 space-y-2.5 text-[13px]">
            <li>
              <Link href="/about" className="text-neutral-700 transition-colors hover:text-foreground">
                About SDB WEAR
              </Link>
            </li>
            <li>
        ...
        <nav aria-label="Legal" className="md:col-span-2">
          ...
          <ul className="mt-5 space-y-2.5 text-[13px]">
            <li>
              <Link href="/privacy-policy" className="text-neutral-700 transition-colors hover:text-foreground">
                Privacy
              </Link>
            </li>
            <li>
              <Link href="/terms" className="text-neutral-700 transition-colors hover:text-foreground">
                Terms
              </Link>
            </li>
            <li>
              <Link href="/cookie-policy" className="text-neutral-700 transition-colors hover:text-foreground">
                Cookie policy
              </Link>
            </li>
            <li>
              <Link href="/cancellation-policy" className="text-neutral-700 transition-colors hover:text-foreground">
                Cancellations
              </Link>
            </li>
          </ul>
