...
from (values
  ...
  ('moto-suits', 'sdb-wear-premium-track-racing-suit', 'SDB WEAR Premium Track Racing Suit',
   ...
   'The premium track suit: a one-piece racing cut with multi-panel leather construction, hard knee sliders, and generous perforation zones for airflow. Removable liner, ergonomic stretch gussets, and a close race fit.',
   '/placeholders/moto-suit.svg',
   '["/placeholders/moto-suit.svg","/placeholders/moto-suit-detail.svg","/placeholders/moto-suit-side.svg"]',
